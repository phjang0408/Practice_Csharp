namespace Myspace
{
    class MyClass
    {
        ...
        static void Main(string[] args)
        {
            ...
            Stream stream3 = new FileStream("c.dat", FileMode.OpenOrCreate); // 파일을 열거나 OpenorCreate
            // 파일이 없으면 생성
            Stream stream4 = new FileStream("d.dat", FileMode.Truncate); // 파일을 비워서 열기 Truncate
            Stream stream5 = new FileStream("e.dat", FileMode.Append); // 덧붙이기 모드로 열기 Append
        }
